...
<head>
    ...
    <title>SPS Ormoc EMS | Category</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                            <a href="category_add.php" type="button" class="btn btn-primary">Add New Category</a>
                        </div>
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php
                                    $result = mysql_query("SELECT * FROM tb_category");
                                    while($row=mysql_fetch_array($result)){
                                        ...
                                        <td>".$catinfo[1]."</td>
                                        <td>
                                        <a href='category_update.php?catID=".$catinfo[0]."'>Update</a>
                                        </td>
                                        </tr>
                                        ";
                                    }
