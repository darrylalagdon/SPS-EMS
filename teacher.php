...
<head>
    ...
    <title>SPS Ormoc EMS | Teachers</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                            <a href="teacher_add.php" type="button" class="btn btn-primary">Add New Teacher</a>
                        </div>
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php
                                    $result = mysql_query("SELECT * FROM tb_teacher");
                                    while($row=mysql_fetch_array($result)){
                                        ...
                                        <td>".$teacherinfo[1]."</td>
                                        <td>
                                        <a href='teacher_update.php?teacherID=".$teacherinfo[0]."'>Update</a>
                                        </td>
                                        </tr>
                                        ";
                                    }
