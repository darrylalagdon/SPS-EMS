...
if(isset($_GET['submit'])){
    ...
    $result = mysql_query('SELECT * FROM tb_room WHERE room = "'.$room.'"');
    if(mysql_num_rows($result)>0){
        $errormsg = "Room already existed.<br>";
    }

    if(!$errormsg){
        mysql_query("INSERT INTO tb_room (room) VALUES ('".$room."')");
        header("location:room_add.php?save=success");
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>SPS Ormoc EMS | Add New Room</title>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                            ...
                            if(isset($_GET['save'])){
                                ...
                                New room successfully added. <a href="room.php" class="alert-link">Click here to return to Rooms</a>.
                                </div>
                                </div>
                                ';
                            }
