...
if(isset($_GET['submit'])){
    ...
    $result = mysql_query('SELECT * FROM tb_supplier WHERE supplier_name = "'.$supplier.'" AND company_name = "'.$company.'"');
    if(mysql_num_rows($result)>0){
        $errormsg = "Record already existed.<br>";
    }

    if(!$errormsg){
        mysql_query('INSERT INTO tb_supplier (supplier_name, supplier_contact, company_name) VALUES("'.$supplier.'", "'.$contact.'", "'.$company.'")');
        header("location:supplier_add.php?save=success");
    }
}
?>
<!DOCTYPE html>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                            ...
                            if(isset($_GET['save'])){
                                ...
                                New supplier successfully added. <a href="supplier.php" class="alert-link">Click here to return to Supplier List</a>.
                                </div>
                                </div>
                                ';
                            }
