...
<head>
    ...
    <title>SPS Ormoc EMS | Rooms</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                            <a href="room_add.php" type="button" class="btn btn-primary">Add New Room</a>
                        </div>
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php
                                    $result = mysql_query("SELECT * FROM tb_room");
                                    while($row=mysql_fetch_array($result)){
                                        ...
                                        <td>".$roomInfo[1]."</td>
                                        <td>
                                        <a href='room_update.php?roomID=".$roomInfo[0]."'>Update</a>
                                        </td>
                                        </tr>
                                        ";
                                    }
